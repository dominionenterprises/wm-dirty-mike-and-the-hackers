...
project_id = '454071421203'
model_id = 'yelppredictor-model'

#activity labels
labels = {
	'one': '1 star', 'two': '2 stars', 
...
def train_model():
	...
	api.trainedmodels().insert(project=project_id, body={
		'id': model_id,
		'storageDataLocation': 'yelpuserdata/output.csv',
...
def get_api(api, scope, service_account=True):
	...
	STORAGE = file.Storage('../Data/oAuth2.json') #local storage of oAuth tokens
